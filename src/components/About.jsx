        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                key={feature.title}
                className="glass-strong p-6 rounded-2xl hover:bg-primary-500/20 transition-all duration-300 relative overflow-hidden group cursor-pointer card-hover"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                ...
                <div className="relative z-10">
                  <motion.div
                    className="inline-block p-3 bg-primary-500/20 rounded-xl mb-4 group-hover:bg-primary-500/30 transition-colors"
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.6 }}
                  >
                    <feature.icon className="text-4xl text-primary-400" />
                  </motion.div>
                  <h3 className="text-xl font-semibold mb-2 group-hover:text-primary-400 transition-colors">{feature.title}</h3>
